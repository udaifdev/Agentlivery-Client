...
const Land: React.FC = () => {
  ...
  // Use error handling for the Lottie animation
  ...
  return (
    <div className="relative">
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-teal-900 text-white flex flex-col">
        ...
        {/* Main Content */}
        <main className="container mx-auto px-4 sm:px-6 lg:px-8 flex-grow flex items-center py-8">
              ...
              <div className="relative w-full h-72 md:h-96 lg:h-full">
                <ErrorBoundary fallback={
                  <div className="w-full h-full flex items-center justify-center">
                    <div className="p-12 rounded-lg bg-gradient-to-br from-teal-500/20 to-cyan-500/20 flex flex-col items-center">
                      <svg 
                        xmlns="http://www.w3.org/2000/svg" 
