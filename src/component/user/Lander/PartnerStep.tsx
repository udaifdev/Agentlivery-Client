...
const PartnerStep = () => {
  ...
  // Parallax effect for cards - reduced values for mobile
  const cardOneY = useTransform(smoothProgress, [0.1, 0.5], [40, 0]);
  const cardTwoY = useTransform(smoothProgress, [0.2, 0.6], [50, 0]);
  const cardThreeY = useTransform(smoothProgress, [0.3, 0.7], [60, 0]);
  ...
  return (
    ...
    >
      <motion.h1
        style={{ y: useTransform(smoothProgress, [0.1, 0.3], [25, 0]), rotate: rotation }}
